...
function sendJson(res: ServerResponse, status: number, error: string): void {
...
export function serveDashboardStatic(req: IncomingMessage, res: ServerResponse, staticRoot: string, pathname: string): void {
